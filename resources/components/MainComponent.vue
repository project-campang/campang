<template>
    ...
    <div class="main-main">
        <div class="bg-white white-main">
            <div class="main-left">
                <div class="main-left-img">
                <img src="/img/logo-ko3.png" class="main-left-img" alt="">
                </div>
                <div class="main-rank">
                    <button type="button" class="main-rank-btn-left"><h3>캠핑러</h3></button>
                    <button type="button" class="main-rank-btn-right"><h3>캠핑장</h3></button>
